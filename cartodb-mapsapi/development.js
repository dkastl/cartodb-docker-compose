var config = {
    ...
    ,user_from_host: '^(.*)\\.cartodb-mapsapi'
    ...
    ,resources_url_templates: {
        http: 'http://{{=it.user}}.cartodb-mapsapi:{{=it.port}}/api/v1/map',
        https: 'http://cartodb-mapsapi:{{=it.port}}/user/{{=it.user}}/api/v1/map'
    }
    ...
    ,analysis: {
        ...
        batch: {
            ...
            hostHeaderTemplate: '{{=it.username}}.cartodb-mapsapi'
        },
        logger: {
